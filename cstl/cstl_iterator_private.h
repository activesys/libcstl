...
#define _GET_VECTOR_COREPOS(it_iter)               ((it_iter)._t_pos._pby_corepos)
#define _GET_VECTOR_CONTAINER(it_iter)             ((vector_t*)((it_iter)._pt_container))
#define _GET_VECTOR_CONTAINER_TYPE(it_iter)        ((it_iter)._t_containertype)
#define _GET_VECTOR_ITERATOR_TYPE(it_iter)         ((it_iter)._t_iteratortype)
/* list iterator handler */
#define _GET_LIST_COREPOS(it_iter)                 ((it_iter)._t_pos._pby_corepos)
#define _GET_LIST_CONTAINER(it_iter)               ((list_t*)((it_iter)._pt_container))
#define _GET_LIST_CONTAINER_TYPE(it_iter)          ((it_iter)._t_containertype)
#define _GET_LIST_ITERATOR_TYPE(it_iter)           ((it_iter)._t_iteratortype)
/* deque iterator handler */
#define _GET_DEQUE_MAP_POINTER(it_iter)            ((it_iter)._t_pos._t_dequepos._ppby_mappos)
#define _GET_DEQUE_FIRST_POS(it_iter)              ((it_iter)._t_pos._t_dequepos._pby_first)
#define _GET_DEQUE_AFTERLAST_POS(it_iter)          ((it_iter)._t_pos._t_dequepos._pby_afterlast)
#define _GET_DEQUE_COREPOS(it_iter)                ((it_iter)._t_pos._t_dequepos._pby_corepos)
#define _GET_DEQUE_CONTAINER(it_iter)              ((deque_t*)((it_iter)._pt_container))
#define _GET_DEQUE_CONTAINER_TYPE(it_iter)         ((it_iter)._t_containertype)
#define _GET_DEQUE_ITERATOR_TYPE(it_iter)          ((it_iter)._t_iteratortype)
/* slist iterator handler */
#define _GET_SLIST_COREPOS(it_iter)                ((it_iter)._t_pos._pby_corepos)
#define _GET_SLIST_CONTAINER(it_iter)              ((slist_t*)((it_iter)._pt_container))
#define _GET_SLIST_CONTAINER_TYPE(it_iter)         ((it_iter)._t_containertype)
#define _GET_SLIST_ITERATOR_TYPE(it_iter)          ((it_iter)._t_iteratortype)
/* avl_tree iterator handler */
#define _GET_AVL_TREE_COREPOS(it_iter)             ((it_iter)._t_pos._t_treepos._pby_corepos)
#define _GET_AVL_TREE(it_iter)                     ((_avl_tree_t*)((it_iter)._t_pos._t_treepos._pt_tree))
#define _GET_AVL_TREE_POINTER(it_iter)             ((it_iter)._t_pos._t_treepos._pt_tree)
/* rb_tree iterator handler */
#define _GET_RB_TREE_COREPOS(it_iter)              ((it_iter)._t_pos._t_treepos._pby_corepos)
#define _GET_RB_TREE(it_iter)                      ((_rb_tree_t*)((it_iter)._t_pos._t_treepos._pt_tree))
#define _GET_RB_TREE_POINTER(it_iter)              ((it_iter)._t_pos._t_treepos._pt_tree)
/* set iterator handler */
#define _GET_SET_CONTAINER(it_iter)                ((set_t*)((it_iter)._pt_container))
#define _GET_SET_CONTAINER_TYPE(it_iter)           ((it_iter)._t_containertype)
#define _GET_SET_ITERATOR_TYPE(it_iter)            ((it_iter)._t_iteratortype)
/* multiset iterator handler */
#define _GET_MULTISET_CONTAINER(it_iter)           ((multiset_t*)((it_iter)._pt_container))
#define _GET_MULTISET_CONTAINER_TYPE(it_iter)      ((it_iter)._t_containertype)
#define _GET_MULTISET_ITERATOR_TYPE(it_iter)       ((it_iter)._t_iteratortype)
/* map iterator handler */
#define _GET_MAP_CONTAINER(it_iter)                ((map_t*)((it_iter)._pt_container))
#define _GET_MAP_CONTAINER_TYPE(it_iter)           ((it_iter)._t_containertype)
#define _GET_MAP_ITERATOR_TYPE(it_iter)            ((it_iter)._t_iteratortype)
/* multimap iterator handler */
#define _GET_MULTIMAP_CONTAINER(it_iter)           ((multimap_t*)((it_iter)._pt_container))
#define _GET_MULTIMAP_CONTAINER_TYPE(it_iter)      ((it_iter)._t_containertype)
#define _GET_MULTIMAP_ITERATOR_TYPE(it_iter)       ((it_iter)._t_iteratortype)
