...
#define _GET_HASH_SET_TYPE_NAME(phset_set)             ((phset_set)->_t_hashtable._t_typeinfo._sz_typename)
#define _GET_HASH_SET_TYPE_BASENAME(phset_set)         ((phset_set)->_t_hashtable._t_typeinfo._pt_type->_sz_typename)
