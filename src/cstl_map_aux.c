/*
 *  The implementation of map auxiliary functions.
 ...
 */
bool_t _map_same_pair_type(const pair_t* cppair_first, const pair_t* cppair_second)
{
...
void _map_value_compare(const void* cpv_first, const void* cpv_second, void* pv_output)
{
