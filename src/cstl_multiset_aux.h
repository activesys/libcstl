...
#define _GET_MULTISET_TYPE_NAME(pmset_mset)             ((pmset_mset)->_t_tree._t_typeinfo._sz_typename)
#define _GET_MULTISET_TYPE_BASENAME(pmset_mset)         ((pmset_mset)->_t_tree._t_typeinfo._pt_type->_sz_typename)
