...
#define _GET_SET_TYPE_NAME(pset_set)             ((pset_set)->_t_tree._t_typeinfo._sz_typename)
#define _GET_SET_TYPE_BASENAME(pset_set)         ((pset_set)->_t_tree._t_typeinfo._pt_type->_sz_typename)
