...
#define _GET_MULTIMAP_FIRST_TYPE_NAME(pmmap_map)              ((pmmap_map)->_pair_temp._t_typeinfofirst._sz_typename)
#define _GET_MULTIMAP_FIRST_TYPE_BASENAME(pmmap_map)          ((pmmap_map)->_pair_temp._t_typeinfofirst._pt_type->_sz_typename)
...
#define _GET_MULTIMAP_SECOND_TYPE_NAME(pmmap_map)             ((pmmap_map)->_pair_temp._t_typeinfosecond._sz_typename)
#define _GET_MULTIMAP_SECOND_TYPE_BASENAME(pmmap_map)         ((pmmap_map)->_pair_temp._t_typeinfosecond._pt_type->_sz_typename)
