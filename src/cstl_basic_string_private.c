...
size_t _basic_string_find_elem_varg(const basic_string_t* cpt_basic_string, size_t t_pos, va_list val_elemlist)
{
    ...
    pv_varg = _alloc_allocate(&((basic_string_t*)cpt_basic_string)->_t_vector._t_allocater, t_typesize, 1);
    assert(pv_varg != NULL);
    ...
    _alloc_deallocate(&((basic_string_t*)cpt_basic_string)->_t_vector._t_allocater, pv_varg, t_typesize, 1);
...
void _basic_string_assign_elem_varg(basic_string_t* pt_basic_string, size_t t_count, va_list val_elemlist)
{
    ...
    _vector_assign_elem_varg(&pt_basic_string->_t_vector, t_count, val_elemlist);
}
    ...
    basic_string_t* pt_basic_string, basic_string_iterator_t it_pos, size_t t_count, va_list val_elemlist)
{
    ...
    it_iter = _vector_insert_n_varg(&pt_basic_string->_t_vector, it_pos, t_count, val_elemlist);
...
void _basic_string_insert_elem_varg(basic_string_t* pt_basic_string, size_t t_pos, size_t t_count, va_list val_elemlist)
{
    ...
    _vector_insert_n_varg(&pt_basic_string->_t_vector, it_pos, t_count, val_elemlist);
}
