...
UT_SUIT_DEFINATION(cstl_hash_multimap_aux, _hash_multimap_same_pair_type_ex)

/*
 * test _hash_multimap_same_pair_type_ex
 */
UT_CASE_DEFINATION(_hash_multimap_same_pair_type_ex)
void test__hash_multimap_same_pair_type_ex__first_null(void** state)
{
    pair_t* ppair = create_pair(int, int);
    pair_init(ppair);

    expect_assert_failure(_hash_multimap_same_pair_type_ex(NULL, ppair));
...
void test__hash_multimap_same_pair_type_ex__second_null(void** state)
{
    ...
    expect_assert_failure(_hash_multimap_same_pair_type_ex(ppair, NULL));
...
void test__hash_multimap_same_pair_type_ex__first_noninited(void** state)
{
    ...
    expect_assert_failure(_hash_multimap_same_pair_type_ex(ppair_first, ppair_second));
...
void test__hash_multimap_same_pair_type_ex__same_pair(void** state)
{
    ...
    assert_true(_hash_multimap_same_pair_type_ex(ppair, ppair));
...
void test__hash_multimap_same_pair_type_ex__not_same_first_type(void** state)
{
    ...
    assert_false(_hash_multimap_same_pair_type_ex(ppair_first, ppair_second));
...
void test__hash_multimap_same_pair_type_ex__same_type(void** state)
{
    ...
    assert_true(_hash_multimap_same_pair_type_ex(ppair_first, ppair_second));
 ...
 */
UT_CASE_DEFINATION(_hash_multimap_same_pair_type)
void test__hash_multimap_same_pair_type__first_null(void** state)
{
    pair_t* ppair = create_pair(int, int);
    pair_init(ppair);

    expect_assert_failure(_hash_multimap_same_pair_type(NULL, ppair));
...
void test__hash_multimap_same_pair_type__second_null(void** state)
{
    ...
    expect_assert_failure(_hash_multimap_same_pair_type(ppair, NULL));
...
void test__hash_multimap_same_pair_type__first_noninited(void** state)
{
    ...
    ppair_first->_t_typeinfofirst._t_style = 99999;
    expect_assert_failure(_hash_multimap_same_pair_type(ppair_first, ppair_second));
    ppair_first->_t_typeinfofirst._t_style = _TYPE_C_BUILTIN;
...
void test__hash_multimap_same_pair_type__same_pair(void** state)
{
    ...
    assert_true(_hash_multimap_same_pair_type(ppair, ppair));
...
void test__hash_multimap_same_pair_type__not_same_first_type(void** state)
{
    ...
    assert_false(_hash_multimap_same_pair_type(ppair_first, ppair_second));
...
void test__hash_multimap_same_pair_type__not_mapkeycompare(void** state)
{
    ...
    ppair_first->_bfun_mapkeycompare = (binary_function_t)0x3333;
    assert_true(_hash_multimap_same_pair_type(ppair_first, ppair_second));
 ...
 */
UT_CASE_DEFINATION(_hash_multimap_value_compare)
void test__hash_multimap_value_compare__null_first(void** state)
{
    int n_second;
    bool_t b_output;

    expect_assert_failure(_hash_multimap_value_compare(NULL, &n_second, &b_output));
}
...
void test__hash_multimap_value_compare__null_second(void** state)
{
    ...
    expect_assert_failure(_hash_multimap_value_compare(&n_first, NULL, &b_output));
}
...
void test__hash_multimap_value_compare__null_output(void** state)
{
    ...
    expect_assert_failure(_hash_multimap_value_compare(&n_first, &n_second, NULL));
}
...
void test__hash_multimap_value_compare__noninited_first(void** state)
{
    ...
    expect_assert_failure(_hash_multimap_value_compare(ppair_first, ppair_second, &b_output));
    ppair_first->_t_typeinfofirst._t_style = _TYPE_C_BUILTIN;
...
void test__hash_multimap_value_compare__no_mapkeycompare_result_true(void** state)
{
    ...
    _hash_multimap_value_compare(ppair_first, ppair_second, &b_output);
...
void _test__hash_multimap_value_compare(const void* cpv_first, const void* cpv_second, void* pv_output)
{
...
void test__hash_multimap_value_compare__user_mapkeycompare_result_true(void** state)
{
    ...
    ppair_first->_bfun_mapkeycompare = _test__hash_multimap_value_compare;
    pair_init_elem(ppair_second, 53, 30);
    ppair_second->_bfun_mapkeycompare = _test__hash_multimap_value_compare;
 ...
 */
UT_CASE_DEFINATION(_hash_multimap_default_hash)
void test__hash_multimap_default_hash__null_input(void** state)
{
    size_t t_result;
    expect_assert_failure(_hash_multimap_default_hash(NULL, &t_result));
}
...
void test__hash_multimap_default_hash__null_output(void** state)
{
    ...
    expect_assert_failure(_hash_multimap_default_hash(ppair_pair, NULL));
...
void test__hash_multimap_default_hash__int(void** state)
{
    ...
    _hash_multimap_default_hash(ppair_pair, &t_result);
