#ifndef _UT_CSTL_SET_AUX_H_
#define _UT_CSTL_SET_AUX_H_

UT_SUIT_DECLARATION(cstl_set_aux)

/*
 * test _set_get_varg_value_auxiliary
 */
UT_CASE_DECLARATION(_set_get_varg_value_auxiliary)
 ...
 */
UT_CASE_DECLARATION(_set_destroy_varg_value_auxiliary)
...
#define UT_CSTL_SET_AUX_CASE\
    UT_SUIT_BEGIN(cstl_set_aux, test__set_get_varg_value_auxiliary__null_set_container),\
    UT_CASE(test__set_get_varg_value_auxiliary__null_node),\
    UT_CASE(test__set_get_varg_value_auxiliary__c_builtin),\
    UT_CASE(test__set_get_varg_value_auxiliary__cstr),\
    UT_CASE(test__set_get_varg_value_auxiliary__libcstl_builtin),\
