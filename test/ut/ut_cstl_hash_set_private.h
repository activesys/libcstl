#ifndef _UT_CSTL_HASH_SET_PRIVATE_H_
#define _UT_CSTL_HASH_SET_PRIVATE_H_

UT_SUIT_DECLARATION(cstl_hash_set_private)
/*
 * test _create_hash_set
 */
UT_CASE_DECLARATION(_create_hash_set)
 ...
 */
UT_CASE_DECLARATION(_create_hash_set_auxiliary)
 ...
 */
UT_CASE_DECLARATION(_hash_set_destroy_auxiliary)
...
#define UT_CSTL_HASH_SET_PRIVATE_CASE\
    ...
    UT_CASE(test__create_hash_set__c_builtin),\
    UT_CASE(test__create_hash_set__cstr),\
    UT_CASE(test__create_hash_set__libcstl_builtin),\
    UT_CASE(test__create_hash_set__user_define),\
    UT_CASE(test__create_hash_set__unregister),\
    UT_CASE_BEGIN(_create_hash_set_auxiliary, test__create_hash_set_auxiliary__null_hash_set),\
    UT_CASE(test__create_hash_set_auxiliary__null_typename),\
    UT_CASE(test__create_hash_set_auxiliary__unregistered),\
    UT_CASE(test__create_hash_set_auxiliary__c_builtin),\
    UT_CASE(test__create_hash_set_auxiliary__cstr),\
    UT_CASE(test__create_hash_set_auxiliary__libcstl_builtin),\
    UT_CASE(test__create_hash_set_auxiliary__user_define),\
    UT_CASE_BEGIN(_hash_set_destroy_auxiliary, test__hash_set_destroy_auxiliary__null_hash_set),\
    ...
    UT_CASE(test__hash_set_find__hash_set_find_varg__c_builtin_not_find),\
    UT_CASE(test__hash_set_find__hash_set_find_varg__cstr_find),\
    UT_CASE(test__hash_set_find__hash_set_find_varg__cstr_not_find),\
    UT_CASE(test__hash_set_find__hash_set_find_varg__libcstl_builtin_find),\
    UT_CASE(test__hash_set_find__hash_set_find_varg__libcstl_builtin_not_find),\
    UT_CASE(test__hash_set_find__hash_set_find_varg__user_define_find),\
    UT_CASE(test__hash_set_find__hash_set_find_varg__user_define_not_find),\
    UT_CASE_BEGIN(_hash_set_count__hash_set_count_varg, test__hash_set_count__hash_set_count_varg__null_hash_set),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__non_inited),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__c_builtin_0),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__c_builtin_1),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__c_builtin_n),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__cstr_0),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__cstr_1),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__cstr_n),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__libcstl_builtin_0),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__libcstl_builtin_1),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__libcstl_builtin_n),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__user_define_0),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__user_define_1),\
    UT_CASE(test__hash_set_count__hash_set_count_varg__user_define_n),\
    UT_CASE_BEGIN(_hash_set_equal_range__hash_set_equal_range_varg, test__hash_set_equal_range__hash_set_equal_range_varg__null_hash_set),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__non_inited),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__c_builtin_equal),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__c_builtin_greater),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__cstr_upper_equal),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__cstr_greater),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__libcstl_builtin_equal),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__libcstl_builtin_greater),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__user_define_equal),\
    UT_CASE(test__hash_set_equal_range__hash_set_equal_range_varg__user_define_greater),\
    UT_CASE_BEGIN(_hash_set_erase__hash_set_erase_varg, test__hash_set_erase__hash_set_erase_varg__null_hash_set),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__non_inited),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__c_builtin_0),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__c_builtin_1),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__c_builtin_n),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__cstr_0),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__cstr_1),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__cstr_n),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__libcstl_builtin_0),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__libcstl_builtin_1),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__libcstl_builtin_n),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__user_define_0),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__user_define_1),\
    UT_CASE(test__hash_set_erase__hash_set_erase_varg__user_define_n),\
    UT_CASE_BEGIN(_hash_set_insert__hash_set_insert_varg, test__hash_set_insert_varg__null_hash_set),\
    UT_CASE(test__hash_set_insert_varg__non_inited),\
    UT_CASE(test__hash_set_insert_varg__c_builtin_equal),\
    UT_CASE(test__hash_set_insert_varg__c_builtin_not_equal),\
    UT_CASE(test__hash_set_insert_varg__cstr_equal),\
    UT_CASE(test__hash_set_insert_varg__cstr_not_equal),\
    UT_CASE(test__hash_set_insert_varg__libcstl_builtin_equal),\
    UT_CASE(test__hash_set_insert_varg__libcstl_builtin_not_equal),\
    UT_CASE(test__hash_set_insert_varg__user_define_equal),\
    UT_CASE(test__hash_set_insert_varg__user_define_not_equal),\
    UT_CASE_BEGIN(_hash_set_init_elem_auxiliary, test__hash_set_init_elem_auxiliary__null_hash_set_container),\
    UT_CASE(test__hash_set_init_elem_auxiliary__null_elem),\
    UT_CASE(test__hash_set_init_elem_auxiliary__successfully_int),\
    UT_CASE(test__hash_set_init_elem_auxiliary__successfully_cstr),\
