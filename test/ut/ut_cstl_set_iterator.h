 ...
 */
UT_CASE_DECLARATION(_set_iterator_get_value)
 ...
 */
UT_CASE_DECLARATION(_set_iterator_get_pointer)
 ...
 */
UT_CASE_DECLARATION(_set_iterator_get_pointer_ignore_cstr)
 ...
 */
UT_CASE_DECLARATION(_set_iterator_next)
 ...
 */
UT_CASE_DECLARATION(_set_iterator_prev)
 ...
 */
UT_CASE_DECLARATION(_set_iterator_equal)
 ...
 */
UT_CASE_DECLARATION(_set_iterator_distance)
 ...
 */
UT_CASE_DECLARATION(_set_iterator_before)
...
#define UT_CSTL_SET_ITERATOR_CASE\
    ...
    UT_CASE_BEGIN(_set_iterator_get_value, test__set_iterator_get_value__null_corepos),\
    UT_CASE(test__set_iterator_get_value__null_tree),\
    UT_CASE(test__set_iterator_get_value__invalid_container_type),\
    UT_CASE(test__set_iterator_get_value__invalid_iterator_type),\
    UT_CASE(test__set_iterator_get_value__end),\
    UT_CASE(test__set_iterator_get_value__null_value),\
    UT_CASE(test__set_iterator_get_value__c_builtin),\
    UT_CASE(test__set_iterator_get_value__cstr),\
    UT_CASE(test__set_iterator_get_value__libcstl_builtin),\
    UT_CASE(test__set_iterator_get_value__user_define),\
    UT_CASE_BEGIN(_set_iterator_get_pointer, test__set_iterator_get_pointer__null_corepos),\
    UT_CASE(test__set_iterator_get_pointer__null_tree),\
    UT_CASE(test__set_iterator_get_pointer__invalid_container_type),\
    UT_CASE(test__set_iterator_get_pointer__invalid_iterator_type),\
    UT_CASE(test__set_iterator_get_pointer__end),\
    UT_CASE(test__set_iterator_get_pointer__c_builtin),\
    UT_CASE(test__set_iterator_get_pointer__cstr),\
    UT_CASE(test__set_iterator_get_pointer__libcstl_builtin),\
    UT_CASE(test__set_iterator_get_pointer__user_define),\
    UT_CASE_BEGIN(_set_iterator_get_pointer_ignore_cstr, test__set_iterator_get_pointer_ignore_cstr__null_corepos),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__null_tree),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__invalid_container_type),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__invalid_iterator_type),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__end),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__c_builtin),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__cstr),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__libcstl_builtin),\
    UT_CASE(test__set_iterator_get_pointer_ignore_cstr__user_define),\
    UT_CASE_BEGIN(_set_iterator_next, test__set_iterator_next__null_corepos),\
    UT_CASE(test__set_iterator_next__null_tree),\
    UT_CASE(test__set_iterator_next__invalid_container_type),\
    UT_CASE(test__set_iterator_next__invalid_iterator_type),\
    UT_CASE(test__set_iterator_next__end),\
    UT_CASE(test__set_iterator_next__last),\
    UT_CASE(test__set_iterator_next__begin),\
    UT_CASE_BEGIN(_set_iterator_prev, test__set_iterator_prev__null_corepos),\
    UT_CASE(test__set_iterator_prev__null_tree),\
    UT_CASE(test__set_iterator_prev__invalid_containter_type),\
    UT_CASE(test__set_iterator_prev__invalid_iterator_type),\
    UT_CASE(test__set_iterator_prev__begin),\
    UT_CASE(test__set_iterator_prev__end),\
    UT_CASE(test__set_iterator_prev__last),\
    UT_CASE_BEGIN(_set_iterator_equal, test__set_iterator_equal__invalid_first),\
    UT_CASE(test__set_iterator_equal__invalid_second),\
    UT_CASE(test__set_iterator_equal__not_same_set),\
    UT_CASE(test__set_iterator_equal__equal),\
    UT_CASE(test__set_iterator_equal__not_equal),\
    UT_CASE_BEGIN(_set_iterator_distance, test__set_iterator_distance__invalid_first),\
    UT_CASE(test__set_iterator_distance__invalid_second),\
    UT_CASE(test__set_iterator_distance__not_same_set),\
    UT_CASE(test__set_iterator_distance__0),\
    UT_CASE(test__set_iterator_distance__greater_0),\
    UT_CASE(test__set_iterator_distance__less_0),\
    UT_CASE_BEGIN(_set_iterator_before, test__set_iterator_before__invalid_first),\
    UT_CASE(test__set_iterator_before__invalid_second),\
    UT_CASE(test__set_iterator_before__not_same_set),\
    UT_CASE(test__set_iterator_before__equal),\
    UT_CASE(test__set_iterator_before__true),\
    UT_CASE(test__set_iterator_before__false)
