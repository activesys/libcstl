 ...
 */
UT_CASE_DECLARATION(hash_multimap_init_copy_array)
 ...
 */
UT_CASE_DECLARATION(hash_multimap_init_copy_array_ex)
 ...
 */
UT_CASE_DECLARATION(hash_multimap_insert_array)
...
#define UT_CSTL_HASH_MULTIMAP_CASE\
    ...
    UT_CASE_BEGIN(hash_multimap_init_copy_array, test_hash_multimap_init_copy_array__null_hash_multimap),\
    UT_CASE(test_hash_multimap_init_copy_array__non_created_hash_multimap),\
    UT_CASE(test_hash_multimap_init_copy_array__non_created_hash_multimap_pair),\
    UT_CASE(test_hash_multimap_init_copy_array__invalid_array),\
    UT_CASE(test_hash_multimap_init_copy_array__invalid_array_not_same_type),\
    UT_CASE(test_hash_multimap_init_copy_array__empty),\
    UT_CASE(test_hash_multimap_init_copy_array__non_empty),\
    UT_CASE(test_hash_multimap_init_copy_array__non_empty_dup),\
    ...
    UT_CASE(test_hash_multimap_init_copy_array_ex__non_created_hash_multimap),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__non_created_hash_multimap_pair),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__invalid_array),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__invalid_array_not_same_type),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__empty),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__non_empty),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__non_empty_dup),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__bucketcount),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__hash),\
    UT_CASE(test_hash_multimap_init_copy_array_ex__compare),\
    ...
    UT_CASE_BEGIN(hash_multimap_insert_array, test_hash_multimap_insert_array__null_hash_multimap),\
    UT_CASE(test_hash_multimap_insert_array__non_inited),\
    UT_CASE(test_hash_multimap_insert_array__non_inited_pair),\
    UT_CASE(test_hash_multimap_insert_array__invalid_array),\
    UT_CASE(test_hash_multimap_insert_array__not_same_type),\
    UT_CASE(test_hash_multimap_insert_array__empty),\
    UT_CASE(test_hash_multimap_insert_array__non_empty_equal),\
    UT_CASE(test_hash_multimap_insert_array__non_empty_dest_src_dup),\
